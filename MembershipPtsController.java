...
public class MembershipPtsController implements Initializable {
    ...
    private void handleSubmit(ActionEvent event) throws IOException {
        ...
        String forSql=""; //will be used in prepared statement
        String threshold = input_value.getText(); //will be used to set value above or below

        //if selected above, the query 'Christian_MemberPtsGT_Mode' will run using the threshold input.
        if (above.isArmed()) {
            forSql ="SELECT DISTINCT\n" +
        ...
        try {
            pst = con.prepareStatement(forSql);
